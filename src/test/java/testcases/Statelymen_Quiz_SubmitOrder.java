...
*/ 		
		...
		// Scroll approx half page with wait
		WebDriverWait waitScroll = new WebDriverWait(driver, Duration.ofSeconds(10));

		// Wait for page to load any element (example: body tag)
		waitScroll.until(ExpectedConditions.presenceOfElementLocated(By.tagName("body")));
...
////		WebDriverWait wait19b= new WebDriverWait(driver, Duration.ofSeconds(10));
////		wait19b.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".csm-cc-btn)")));
////		driver.findElement(By.cssSelector(".csm-cc-btn")).click();
//		
//		// click checkout button
//		driver.findElement(By.xpath("//*[@id=\"checkout-button\"]")).click();
		
		JavascriptExecutor js = (JavascriptExecutor) driver;
		WebDriverWait waitScroll2 = new WebDriverWait(driver, Duration.ofSeconds(10));

		By checkoutBtn = By.xpath("//*[@id='checkout-button']");

		while (true) {

		    try {
		        // If checkout button becomes clickable → click & break the loop
		        WebElement btn = waitScroll2.until(ExpectedConditions.elementToBeClickable(checkoutBtn));
		        btn.click();
		        break;

		    } catch (Exception e) {
		        // If not found → scroll 1000px
		...
		WebDriverWait waitCheckoutPage= new WebDriverWait(driver, Duration.ofSeconds(10));
		waitCheckoutPage.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"csm-wrapper\"]/div/div/div[2]/button")));
		...
		wait20.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"plan-upsell\"]/div[2]/div[4]/button")));
